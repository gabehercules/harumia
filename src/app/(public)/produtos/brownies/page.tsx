        ...
        <main className="py-12 bg-brand-beige/40 min-h-screen">
            <div className="container mx-auto px-4">
                <header className="mb-8 text-center">
                    <h1 className="font-clash text-3xl sm:text-4xl font-extrabold text-brand-brown">Brownies</h1>
                    <p className="mx-auto mt-3 max-w-2xl text-base sm:text-lg text-brand-brown/90">
                        Nossos brownies artesanais: do clássico fudge ao irresistível recheado.
                    </p>
                    <div className="mt-4">
